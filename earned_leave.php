...
<div class="container">
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
        <div class="form-row">
            ...
            <input type="text" id="employeeID" name="employeeID" value="<?php echo $_SESSION['UID']; ?>" readonly>
        </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($resultCheck->num_rows > 0) {
        ...
        if ($resultLeaveBalance->num_rows > 0) {
            ...
            $casualLeaveBalance = $leaveBalanceRow["earned_leave"];
            ...
            if ($casualLeaveBalance > 0) {
                ...
                $sql = "INSERT INTO Attendance (EmployeeID, Date, Day, Reporting, Status, Approval) 
                        VALUES ('$employeeID', '$date', '$day', '$reporting', 'earned_leave', '$approval')";
                
                // Update leave balance after leave is granted
                $updateLeaveBalanceQuery = "UPDATE leave_balance 
                                            SET earned_leave = earned_leave - 1 
                                            WHERE id = '$employeeID'";
