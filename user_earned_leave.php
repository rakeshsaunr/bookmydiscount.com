...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($resultCheck === FALSE) {
        ...
        if ($resultCheck->num_rows > 0) {
            ...
            if ($resultLeaveBalance === FALSE) {
                ...
                if ($resultLeaveBalance->num_rows > 0) {
                    ...
                    $earnedLeaveBalance = $leaveBalanceRow["Earned_Leave"];
        ...
        VALUES ('$employeeID', '$fromDate', '$toDate', '$day', '$reporting', 'earned_leave', '$approval')";

                        // Update leave balance after leave is granted
                        $updateLeaveBalanceQuery = "UPDATE user 
                                                    SET Earned_Leave = Earned_Leave - $dateDiff 
                                                    WHERE id = '$employeeID'";
